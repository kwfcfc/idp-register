...
-- Initial PostgreSQL schema for a fresh idp-register deployment.
--
-- This file is intentionally equivalent to internal/store/schema_pg.sql.
-- The application currently applies the embedded internal/store schema on
-- startup; this copy exists for operators and schema review.
